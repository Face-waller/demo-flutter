...
class _MyGroupAnimationState extends State<MyGroupAnimation> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _sizeAnimation1 = Tween(begin: 100.0, end: 300.0).animate(CurvedAnimation(
        parent: _animationController, curve: Interval(0.5, 1.0)
    ));

    _colorAnimation2 = ColorTween(begin: Colors.red, end: Colors.blue).animate(CurvedAnimation(
        parent: _animationController, curve: Interval(0.0, 0.5)
    ));

    _sizeAnimation2 = Tween(begin: 100.0, end: 300.0).animate(CurvedAnimation(
        parent: _animationController, curve: Interval(0.5, 1.0)
    ));
